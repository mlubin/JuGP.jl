...
@testset "Monomial--" begin
    ...
    @testset "--Posynomial" begin
        ...
        @test Monomial(3) - Posynomial(1,2) == Posynomial(3,-1,-2)
        @test Monomial(2,Dict(1=>2,2=>3)) *
                Posynomial(Monomial(3,Dict(1=>3,3=>5)),Monomial(2)) ==
            Posynomial(Monomial(6,Dict(1=>5,2=>3,3=>5)),
                       Monomial(4,Dict(1=>2,2=>3)))
...
@testset "Posynomial--" begin
    ...
    @testset "--Monomial" begin
        ...
        @test Posynomial(9,6) / Monomial(3,Dict(2=>4,3=>5)) ==
            Posynomial(Monomial(3,Dict(2=>-4,3=>-5)),
                       Monomial(2,Dict(2=>-4,3=>-5)))
    end
    @testset "--Posynomial" begin
        p34 = Posynomial(3,4)
